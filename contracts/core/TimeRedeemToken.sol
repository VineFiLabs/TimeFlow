...
{   
    ...
    address public currentTimeFlowFactory;
    ...
    /**
     * @dev Sets the values for {deciamls}, {marketId}, {name} and {symbol}.
     *
     * All two of these values are immutable: they can only be set once during
     * construction.
     */
    constructor(address _timeFlowFactory, uint256 _marketId, string memory name_, string memory symbol_) {
        currentTimeFlowFactory = _timeFlowFactory;
    ...
    modifier onlyCaller {
        require(msg.sender == ITimeFlowFactory(currentTimeFlowFactory).getMarketInfo(currentMarketId).market, "Non caller");
        _;
    }
